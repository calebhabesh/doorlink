...
5. **Upload:** Image and visitor recordings have stable per-press identifiers. The gateway groups them into one session, deduplicates retries per press, coalesces rapid whole-home webhook requests into a 750 ms leading/trailing window, and publishes lifecycle updates over SSE.
