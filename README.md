...
5. **Upload:** Image and visitor recordings have stable per-press identifiers. The gateway groups them into one session, deduplicates retries per press, applies a 2.6-second leading-edge whole-home chime cooldown without queueing suppressed presses, and publishes lifecycle updates over SSE.
