  ...
  return (
    <div className="bg-zinc-950/50 backdrop-blur-md border border-zinc-800 p-6 rounded-3xl flex flex-col hover:border-zinc-700 transition-all duration-300 shadow-lg group relative overflow-hidden animate-flash-event">
      ...
      <div className="flex justify-between items-start mb-4">
        <div>
          <h3 className="text-zinc-500 text-xs font-bold uppercase tracking-widest mb-1 flex items-center gap-1.5 text-left">
            <Battery className="w-3.5 h-3.5 text-zinc-400" />
            Device Power
          </h3>
          <p className="text-2xl sm:text-3xl font-black text-white tracking-tight tabular-nums select-none text-left">
            {percentage}%
          </p>
        </div>
      ...
      {/* Visual Battery Bar */}
      <div className="w-full h-3 bg-zinc-900 rounded-full overflow-hidden border border-zinc-850 p-[1px] mb-4">
        <div 
      ...
      <p className="text-[10px] text-zinc-500 mt-3 font-mono flex items-center gap-1 leading-normal text-left">
