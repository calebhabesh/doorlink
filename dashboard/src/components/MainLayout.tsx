...
export default function MainLayout({ 
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 lg:flex font-sans">
      ...
      {/* Main Content Area */}
      <main className="flex-1 bg-zinc-900 min-h-[calc(100vh-4rem)] lg:min-h-screen lg:my-3 lg:rounded-l-[2rem] border-l border-t border-b border-zinc-800 shadow-2xl relative flex flex-col overflow-hidden">
