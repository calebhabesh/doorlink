...
export default function PttButton() {
  ...
  return (
    <button
      ...
      className={`select-none touch-none flex items-center gap-2 px-6 py-3.5 rounded-xl text-sm font-bold uppercase tracking-widest transition-all shadow-xl border ${
        isRecording
