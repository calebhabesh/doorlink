...
export default function PttButton() {
  ...
  return (
    <button
      ...
      className={`select-none touch-none flex items-center gap-1.5 sm:gap-2 px-4 py-2 sm:px-6 sm:py-3.5 rounded-lg sm:rounded-xl text-xs sm:text-sm font-bold uppercase tracking-widest transition-all shadow-xl border ${
        isRecording
