...
- [ ] **Status LED:** Verify GPIO24 toggles the status LED.
- [ ] **Button Wakeup:** Press the doorbell button. Verify the hardware pulls GPIO38 high/low correctly and the ESP32 logs the interrupt/wakeup.
- [ ] **Battery ADC:** Measure battery voltage via multimeter and compare to ESP32 ADC reading on GPIO1.

## Phase 4: I2C & Camera (OV5640)
- [ ] **I2C Scanner:** Run an I2C scan on pins SDA=31, SCL=32. Verify the OV5640 responds at address `0x3C`.
...
- [ ] **Speaker (MAX98357A):** Drive AMP_EN (GPIO37) HIGH. Initialize I2S TX on WS=4, SCK=5, DIN=7. Play a simple sine wave tone.
