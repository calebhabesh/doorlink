#!/usr/bin/env python3
"""Fail-closed checks for the Smart Doorbell Rev C JLCPCB release candidate."""
...
REV_C_HASHES = RELEASE_DIR / "RELEASE_CANDIDATE.sha256"
...
def main() -> int:
    ...
    checks.require(
        'gr_text "CAM1/\\nJ3-24"' in board_source,
        "PCB lacks the CAM1 / J3-24 silkscreen label",
    )
    checks.require(
        'gr_text "CAM24/\\nJ3-1"' in board_source,
    ...
    print("Rev C release verification passed:")
